...
public class DESUtil {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("key:"+generateKey("123456789"));
        System.out.println(encrypt(generateKey("123456789").toString(),"0901"));
        System.out.println(decrypt(generateKey("123456789").toString(),encrypt(generateKey("123456789").toString(),"0901")));
    }
